...
theorem ForcingContext.woodinSparse_quotient_directedClosedBelow [Countable V]
  ...
  have hclosed : ∀ (B : ForcingContext V),
    ...
    intro B hBP hBR hBo
    exact B.woodinActual_quotient_directedClosedBelow hΩ hAC
...
theorem ForcingContext.woodinSparseSource_quotient_directedClosedBelow [Countable V]
    (A : ForcingContext V) {Ω θ i : V} [IsOrdinal θ]
    (hΩ : IsWoodinSupercompact Ω) (hAC : ¬InternalChoice V) (hθ : θ ⊆ Ω) (hi : i ∈ θ)
  ...
  exact A.woodinSparse_quotient_directedClosedBelow hΩ hAC hθ hi hP hR ho

theorem ForcingContext.woodinSparseSource_infinite_quotient_directedClosedBelow [Countable V]
    (A : ForcingContext V) {Ω θ i : V} [IsOrdinal θ]
  ...
  simpa only [hiidx, hθidx] using
    A.woodinSparseSource_quotient_directedClosedBelow hΩ hAC hθ hi hP' hR' ho
end ZFVP
