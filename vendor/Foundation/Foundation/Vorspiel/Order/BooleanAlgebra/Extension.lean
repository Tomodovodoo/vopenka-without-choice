...
The normal form of the Boolean subalgebra generated by adjoining one element, companions of
an adjoined element, and the extension of an order isomorphism along it.
-/
